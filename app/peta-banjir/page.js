      ...
      <div className="flex-1 relative">
        ...
        <div className="hidden lg:block absolute top-8 right-8 z-1000 bg-white/90 backdrop-blur-md p-5 rounded-2xl shadow-xl border border-white/50 max-w-md">
          ...
          <p className="text-sm text-slate-600 font-medium">
            Monitoring ketinggian air secara realtime di Pamekasan.
          </p>
        </div>

        {/* Legend Overlay */}
        <div className="absolute bottom-8 right-4 lg:right-8 z-1000 bg-white/90 backdrop-blur-md p-4 rounded-2xl border border-white/50 shadow-xl space-y-3 min-w-45">
          <div className="font-bold text-slate-800 text-sm mb-1 border-b border-slate-100 pb-2 text-center lg:text-left">
            Status Air
          </div>
